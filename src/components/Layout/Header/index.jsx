...
class Header extends React.Component {
  ...
  render() {
    ...
    const logo = globals.config.logo || '/assets/nav-logo.png'
      ...
      >
        <Link to={isAppsPage() && !globals.user ? '/apps' : '/'}>
          <div className={styles.logo}>
            <img src={isAppsPage() ? `/assets/login-logo.png` : logo} alt="" />
            <img className={styles.kubeLogo} src={`/assets/logo.svg`} alt="" />
          </div>
        </Link>
